			...
			<div class="row">
				<div class="col-sm-12">
                    ...
                    <div class="pull-right">
                        <a href="cart/data.php?q=emptycart" class="btn btn-danger btn-lg">Clear Requests!!!</a>
                        <a href="#" class="btn btn-success btn-lg" data-toggle="modal" data-target="#checkout_modal">Buy now</a>
                    </div>
                    <?php }else{ ?>
